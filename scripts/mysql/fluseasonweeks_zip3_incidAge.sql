...
Command Line: mysql < fluseasonweeks_zip3_incidAge.sql | sed 's/\t/,/g' > fluseasonweeks_zip3_incidAge_S#.csv
Data: flu table: SDI
*/
...
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 <> "TOT" and flu.POPSTAT > 0 and season_cdcwk.SMALL_SEAS_NUM = 2
